...
Donations will be used in ways that support Sightstone. 
Examples are:
* A domain
* A code signing license (So you know that you are using Sightstone)";

            #endregion AboutTextbox

            Addtheme("Dark Steel", "pack://application:,,,/Sightstone;component/Controls/Steel.xaml");
            Addtheme("Light Steel", "pack://application:,,,/Sightstone;component/Controls/Steel.xaml");
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            using (var client = new WebClient())
            {
                ...
                {
                    ResultTextbox.Content =
                        "Unable to install hud. Please check the link or try running Sightstone as admin.";
                    ResultTextbox.Visibility = Visibility.Visible;
                }
            }
        }
